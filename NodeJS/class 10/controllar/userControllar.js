...
const signupData = async (req, resp) => {
  try {
    ...
    // const profileImage1 = req.files["profileImage1"] ? req.files["profileImage1"][0] : null;
    // const profileImage2 = req.files["profileImage2"] ? req.files["profileImage2"][0] : null;
    // const profileImage3 = req.files["profileImage3"] ? req.files["profileImage3"][0] : null;

    console.log("Image files:", profileImage);
